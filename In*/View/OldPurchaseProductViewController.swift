//
//  OldPurchaseProductViewController.swift
//  In*
//
...
class OldPurchaseProductViewController: UIViewController {
...
//    }()
    ...
    fileprivate func setupLabel() {
        ...
        NSLayoutConstraint.activate([
            prepaidLabel.topAnchor.constraint(equalTo: deliveryThree.layoutMarginsGuide.bottomAnchor, constant: 26),
    ...
    fileprivate func setupCheckbox() {
        ...
        NSLayoutConstraint.activate([
            checkbox.topAnchor.constraint(equalTo: deliveryThree.layoutMarginsGuide.bottomAnchor, constant: 24),
...
extension OldPurchaseProductViewController: UIPickerViewDelegate, UIPickerViewDataSource {
